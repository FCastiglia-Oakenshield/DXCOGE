...
Public Class MONDOSiglaC
    ...
    Dim Exc As String = "XMONDORIP"
    Dim Exu As String = "XMONDOCREA"
    Dim TOTALEIMP As Decimal = 0

    Private Sub MONDOSiglaC_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
    ...
    Private Sub ButtonEdit2_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles ButtonEdit2.MouseMove
        ...
        Else
            ...
            ButtonEdit2.Properties.Buttons(1).ToolTip = "MANCA COMMESSA"
        End If
    End Sub
...
& " values(@MCCID,@MCCPROG,@MCCPrkAammgg,@MCCPrkId,@MCCPrkProg,@MCCPrkDa,@MCCCogLdp,@MCCCogCdc,@MCCCogRep,@MCCCogDet,@MCCCogConto,@MCCIMPORTO)"
        ...
        For x = 1 To DSCPT.Rows.Count
            ...
            If RWCPT("MCCIMPORTO") <> 0 And RWCPT("TcmRif") > 0 Then
                M = M + 1
                p1.Value = ProgId
                p2.Value = M
    ...
    Sub RiassegnaCommesse()
        ...
        End If
        EliminaCommesse()
        Dim Inser As String = "INSERT INTO TMPTCM (TMPID,TCMRIF,TCMSIGLA) values(@ID,@RIF,@SIGLA)"
    ...
    Function VerificaNrCommesse() As Boolean
        ...
        Cmd = New SqlCommand("SELECT DISTINCT MCCID,MCCIMPORTO,PRKAAMMGG,PRKID,PRKDA,PRKCONTO,TCMRIF,TCMSIGLA,CONTODES,IMPORTO,TOT=(SELECT SUM(IMPORTO) FROM ##TABTO) FROM ##TABCM ORDER BY PRKCONTO", CnDc)
        Dim QV As Integer = 0
        Dim EV As Integer = 0
