...
Public Class MONDOPOP
    ...
    Private Sub MONDOPOP_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        CaricaVIDEO()
    End Sub
    ...
    Sub CaricaVIDEO()
        ...
        Dim Exc As String = "EXEC XMONDORIP @ID=" & Id
        If Ret = True Then Exc = "EXEC RMONDORIP @ID=" & Id
        EsegueSql(Exc, CnDc)
