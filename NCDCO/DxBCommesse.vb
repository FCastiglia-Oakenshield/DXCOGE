...
Public Class DxBCommesse
    ...
    Dim UltimaApertura, sw, MaxEse, EseFormato(5), TipoStampa, EseBilChi(5), CauChiusura, EseAnno(5), NCOMM As Int16
    ...
    End Sub
    Sub PopolaGrid()
        Dim STR As String = "select TcmRif,TcmSigla,TcmNum,TcmOggetto from VCOMMESSE"
    ...
    Sub Stampa()
        ...
        Dim Lancio As String = "Exec DXCOMMESSE " : XtraTabControl1.SelectedTabPageIndex = 1
        Dim Str As String = Lancio & "@DAL='" & DateEdit2.EditValue.ToShortDateString & "',@AL='" & DateEdit1.EditValue.ToShortDateString & "',@FAL='" & DateEdit1.EditValue.ToShortDateString & "'"
        ...
        REPORT = New DxCommesse
        REPORT.DataSource = DsBilCdc
        REPORT.DataMember = "DsBilCbc"
        REPORT.FilterString = selectformula
        REPORT.Parameters("Titolo").Value = "ANNO " & ComboBoxEdit1.EditValue & " - SITUAZIONE  " & DateEdit2.EditValue & " - " & DateEdit1.EditValue & RR
    ...
    Sub PreparoFormula()
        ...
        For jj = 1 To DsAgD.Rows.Count
            ...
            Formula = Formula & "MCCCOGLDP = " & RwAgD("TcmRif")
    ...
    '''    EsegueProcedura("DXCOMMF1", d1, d2, d5, NCOMM)
    '''    StrPrint = "select MCCCOGLDP,MCCCOGCONTO,TMPOGETTO,CONTODES,MCCIMPORTO,PIAFL01 from DXCOMMF1 Order by MCCCOGLDP,PIAFL01,MCCCOGCONTO,CONTODES" '' Order by MCCCOGLDP,MCCCOGCDC,MCCCOGREP,PIAFL01"
    '''End Sub
    '''Function EsegueProcedura(ByVal QualeP As String, ByVal Dal As String, ByVal Al As String, ByVal Fal As String, ByVal NCOMM As Int16) As Boolean
    '''    EsegueSql(" EXEC " & QualeP & "  @DAL ='" & Dal & "', @AL = '" & Al & "' , @FAL = '" & Fal & "' , @NCOMM= " & NCOMM, CnDc)
    '''End Function
