    ...
    Private Sub ScriviCli()
        ...
        If Clie = False Then
            If RILEGGICLI() = 0 Then
                scrivi = "INSERT into TbCli (ClCod,ClPagam,ClAbi,ClCab,ClCC,ClCinEur,ClCin,ClCodBan,ClCntRid,ClAttivo,ClBlackList) VALUES (@ClCod,@ClPagam,@ClAbi,@ClCab,@ClCC,@ClCinEur,@ClCin,@ClCodBan,@ClCntRid,@ClAttivo,@ClBlackList)"
            Else
                scrivi = "Update TbCli set ClPagam=@ClPagam,ClAbi=@ClAbi,ClCab=@ClCab,ClCC=@ClCC,ClCinEur=@ClCinEur,ClCin=@ClCin,ClCodBan=@ClCodBan,ClCntRid=@ClCntRid,ClAttivo=@ClAttivo,ClBlackList=@ClBlackList where ClCod = @ClCod "
            End If
        Else
            scrivi = "Update TbCli set ClPagam=@ClPagam,ClAbi=@ClAbi,ClCab=@ClCab,ClCC=@ClCC,ClCinEur=@ClCinEur,ClCin=@ClCin,ClCodBan=@ClCodBan,ClCntRid=@ClCntRid,ClAttivo=@ClAttivo,ClBlackList=@ClBlackList where ClCod = @ClCod "
        End If
