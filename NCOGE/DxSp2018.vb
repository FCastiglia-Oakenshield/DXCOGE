...
Public Class DxSp2018
    ...
    End Sub
    Private Sub Pulizia()
        RadioGroup1.EditValue = 0 : TextEdit20.EditValue = Nothing : TextEdit21.EditValue = Nothing : ProgInvio = 0 : RadioGroup2.EditValue = ClFo : RadioGroup4.EditValue = RadioGroup2.EditValue : RadioGroup5.EditValue = RadioGroup2.EditValue

        RadioGroup1.Properties.Items(0).Enabled = False : RadioGroup1.Properties.Items(1).Enabled = False : TextEdit22.ResetBackColor()

        XtraTabPage2.PageVisible = False : XtraTabPage3.PageVisible = False : XtraTabPage4.PageVisible = False : XtraTabPage5.PageVisible = False : XtraTabPage6.PageVisible = False : XtraTabPage7.PageVisible = False
    ...
    Private Sub UltimoChiuso()
        ...
        Dim Cmd As New SqlCommand("Select * from TbRegXml where RxInviato = 1 AND RxAnno = @ANNO ORDER BY RxPeriodo desc ", cnCo)
        ...
        Cmd = New SqlCommand("Select isnull(Max(RxProgInvio),0) from TbRegXml", cnCo)
    ...
    Sub RendiTrimestriDisponibili()
        Dim P As Int16
        Dim Cmd As New SqlCommand("Select * from TbVers where IvaVanno =" & ANNO & " and (ivavmese=6 or ivavmese=12)", cnCo)
        dataRd = Cmd.ExecuteReader
        While dataRd.Read
            P = (dataRd.Item("IvaVmese") / 6) - 1
    ...
    Private Sub LeggiPeriodo()
        ...
        Dim Cmd As New SqlCommand("Select * from TbRegXml where RxAnno = @ANNO AND RxPeriodo = @PERIODO ", cnCo)
        Cmd.Parameters.Add(P1)
    ...
    Private Sub Visregistri()
        ...
        Dim RegV As String = "EXEC X_LEGGI_REGXML @ANNO, 'V', @PERIODO"
        Dim RegA As String = "EXEC X_LEGGI_REGXML @ANNO, 'A', @PERIODO"
    ...
    Private Sub RadioGroup1_EditValueChanged(sender As Object, e As System.EventArgs) Handles RadioGroup1.EditValueChanged
        ...
        CambioPeriodo = False
    End Sub
    Private Sub Assegnasemestre()
        Dim MMDA As Int16 = (RadioGroup1.EditValue - 1) * 6 + 1
        Dim MMA As Int16 = (RadioGroup1.EditValue - 1) * 6 + 6
        Dim GGDA As Int16 = 1
    ...
    Private Sub ButtonF1_Click(sender As System.Object, e As System.EventArgs) Handles ButtonF1.Click
        ...
        End If
        Elabora()
        XtraTabPage2.PageVisible = True : XtraTabPage4.PageVisible = True : XtraTabPage5.PageVisible = True : XtraTabPage6.PageVisible = True : XtraTabControl1.SelectedTabPageIndex = 1
        PaginaII()
    End Sub
    ...
    Private Sub Elabora()
        ...
        Cmd = New SqlCommand("DELETE FROM TbRegXML where RxAnno = @ANNO and RxPeriodo = @PERIODO", cnCo)
        Cmd.Parameters.Add(P1)
        Cmd.Parameters.Add(P2)
        Cmd.ExecuteNonQuery()
        ...
        Cmd = New SqlCommand("EXEC XI1XML @ANNO, @PERIODO", cnCo)
        Cmd.Parameters.Add(P1)
        Cmd.Parameters.Add(P2)
        Cmd.ExecuteNonQuery()
    ...
    Private Sub Memorizza(Tipo As String, Registro As Int16, Selezionato As Boolean)
        ...
        Dim P4 As New SqlParameter("@RxPeriodo", SqlDbType.TinyInt)
        ...
        Cmd = New SqlCommand("INSERT INTO TbRegXML (RxAnno,RxTipo,RxRegistro,RxPeriodo,RxDal,RxAl,RxProgInvio,RxSel) VALUES (@RxAnno,@RxTipo,@RxRegistro,@RxPeriodo,@RxDal,@RxAl,@RxProgInvio,@RxSel)", cnCo)
        Cmd.Parameters.Add(P1)
        Cmd.Parameters.Add(P2)
...
#Region "DETTAGLIO FATTURE"
    Private Sub PaginaII()
        ...
        DsMax = New DataTable
        DaMax = New SqlDataAdapter("Select * from VELEXMLFATTURE where EleCfAnno = @ANNO AND  EleCfPeriodo = @PERIODO AND EleCfTipo = @TIPO order by EleCfTipo,EleCfPriRegIva,EleCfNumProt", cnCo)
...
#Region "XML FATTURE"
    ...
    Private Sub CreaFatture()
        ...
        DaDte = New SqlDataAdapter("EXEC X_FATTXML_DTE @ANNO, @PERIODO,@NO_CONTROL", cnCo)
        ...
        Dim P4 As New SqlParameter("@PERIODO", SqlDbType.TinyInt)
        ...
        DaDtr = New SqlDataAdapter("EXEC X_FATTXML_DTR @ANNO, @PERIODO,@NO_CONTROL", cnCo)
    ...
    Private Sub registraprogressivo()
        ...
        Cmd = New SqlCommand("UPDATE TbREGXml set RxInviato = 1, RxNoControl = @NO_CONTROL where RxAnno = @ANNO and RxPeriodo = @PERIODO", cnCo)
        Cmd.Parameters.Add(P1)
        Cmd.Parameters.Add(P2)
        Cmd.Parameters.Add(P4)
        Cmd.ExecuteNonQuery()
        ...
        Cmd = New SqlCommand("UPDATE TbREGXml set RxProgInvio = @PROGINVIO", cnCo)
        Cmd.Parameters.Add(P3)
        Cmd.ExecuteNonQuery()
