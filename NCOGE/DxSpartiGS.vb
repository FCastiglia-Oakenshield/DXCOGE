...
Public Class DxSpartiGS
    ...
    Private Sub GridView2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView2.Click
        REM DISABILITATO x GESTIONE VENDITE GS ( questa e' l'unica modifica)
...
IINext:
    ...
    Sub FormaStringaCorpo()
        StrDue = StrD(1) & StrD(4) & "'" & RwX("PrkConto") & "'" & StrD(3) & "'" & CDate(DateEdit1.EditValue).ToShortDateString & "' AND '" & CDate(DateEdit2.EditValue).ToShortDateString & "'" & StrD(10)
