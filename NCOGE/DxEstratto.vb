...
Public Class DxEstratto
    ...
    Sub LeggiUserId()
        ...
        End While
        dataRd.Close()
        If (Userid = "PASTAECO" Or Userid = "PASTANEW") Then
            PerPasta = True
        End If
    End Sub
    ...
    Private Sub leggiazienda()
        ...
        Dim Email As String = ""
        TextEdit10.EditValue = "" : TextEdit11.EditValue = ""
        ' leggo da tbana
        Dim Cmd1 As New SqlCommand("SELECT AnaDesc, AnaIndirizzo, AnaCap, AnaCitta, AnaProv,AnaTel1,AnaFax,AnaEmail FROM TbAna WHERE AnaGrp = 'AZ' AND AnaCod = '" & Azienda & "'", cnVd)
        ...
        While dataRd.Read
            ...
            TextEdit10.EditValue = ""
            If dataRd.Item("AnaTel1").ToString.Length > 5 Then Telefono &= "Tel. " & dataRd.Item("AnaTel1")
            If dataRd.Item("AnaFax").ToString.Length > 5 Then Telefono &= " - Fax " & dataRd.Item("AnaFax")
            If dataRd.Item("AnaEmail").ToString.Split("@")(0) > "" Then Email &= "Email: " & dataRd.Item("AnaEmail")
        End While
        dataRd.Close()
        If Telefono > "" Then TextEdit10.EditValue = Telefono
        If Email > "" Then TextEdit11.EditValue = Email
    End Sub
    ...
    Private Sub ButtonF9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonF9.Click
        ...
        If PerPasta = True Then GoTo IIPasta
...
IIPasta:
        ...
        Rpt2 = New StTabSCli
        Rpt3 = New StEstLib
        Rpt4 = New StEstrattoFR
        Dim selectformula As String
        If RadioGroup1.SelectedIndex = 0 And CheckEdit3.Checked = False And TextEdit6.EditValue.ToString.ToUpper = "FR" Then
            Rpt = Rpt4
            frm.Text = "Estratto Conto"
            SELESTR = ""
        ElseIf RadioGroup1.SelectedIndex = 0 And CheckEdit3.Checked = False Then
            Rpt = Rpt1
            frm.Text = "Estratto Conto"
            SELESTR = ""
