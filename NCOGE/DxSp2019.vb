...
Public Class DxSp2019
    ...
    Private Sub Pulizia()
        ...
        RadioGroup1.Properties.Items(3).Enabled = False : RadioGroup1.Properties.Items(4).Enabled = False : RadioGroup1.Properties.Items(5).Enabled = False
        RadioGroup1.Properties.Items(6).Enabled = False : RadioGroup1.Properties.Items(7).Enabled = False : RadioGroup1.Properties.Items(8).Enabled = False
        RadioGroup1.Properties.Items(9).Enabled = False : RadioGroup1.Properties.Items(10).Enabled = False : RadioGroup1.Properties.Items(11).Enabled = False
    ...
    Private Sub Iva_Regime()
        ...
        dataRd.Close()
    End Sub
    Sub RendiMesiDisponibili()
        If RegimeIva = 1 Then
            Exit Sub
        End If

        Dim P As Int16
        Dim Cmd As New SqlCommand("Select * from TbVers where IvaVmese > 0 and IvaVmese < 13 and IvaVanno = " & ANNO, cnCo)
        dataRd = Cmd.ExecuteReader
        While dataRd.Read
    ...
    Private Sub RadioGroup1_EditValueChanged(sender As Object, e As System.EventArgs) Handles RadioGroup1.EditValueChanged
        ...
        CambioPeriodo = False
    End Sub
    Private Sub AssegnaMese()
        Dim MMDA As Int16 = (RadioGroup1.EditValue)
        Dim MMA As Int16 = (RadioGroup1.EditValue)
        Dim GGDA As Int16 = 1
