...
Public Class DxSp2012
    ...
    Private Sub DxSp2012_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        SetInizio()
    End Sub
    Sub SetInizio()
...
#Region " 6a CREAZIONE FILE INVIO"
    ...
    Private Sub NomeFiles()
        ...
        End If
        FileEle = PathEle & TextEdit2.EditValue & "_SPES2012.txt"
