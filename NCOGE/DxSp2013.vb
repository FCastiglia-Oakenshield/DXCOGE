...
Public Class DxSp2013
    ...
    Private Sub DxSp2013_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        SetInizio()
    End Sub
    Sub SetInizio()
...
#Region " 6a CREAZIONE FILE INVIO"
    ...
    Private Sub NomeFiles()
        ...
        End If
        FileEle = PathEle & TextEdit2.EditValue & "_SPES2013.txt"
...
#Region "CREAZIONE FILE ELENCHI"
    ...
    Private Sub ButtonF8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonF8.Click
        ...
        DXANTEPRIMA(GridControl3, True, Printing.PaperKind.A4, "STAMPA di CONTROLLO FILE " & FileEle)
    End Sub
