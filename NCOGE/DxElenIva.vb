...
Public Class DxElenIva
    ...
    End Sub
#Region "LETTURA FATTURE e 1a GRID < 25000 euro"
    Sub Pulizia()
    ...
    Sub IPagina()
        ...
        StrR = "Select * from VEleda2010 where EleCfTipo = '" & RadioGroup1.EditValue & "' and EleCfP = 0 AND EleCfAnno = " & ANNO & " order by EleCfAnaDesc,EleCfDataDoc,EleCfNumDoc"
        DsMin = New DataTable
    ...
    Function Controllo() As Boolean
        ...
        Return Msg
    End Function
    Private Sub ButtonXF11_Click(sender As System.Object, e As System.EventArgs) Handles ButtonP1A.Click
        AssociaDaPaginaI()
    End Sub
    ...
    End Sub
#End Region
#Region " 2a GRID >= 25000 euro"
    Sub IIPagina()
        StrR = "Select * from VEleda2010 where EleCfTipo = '" & RadioGroup1.EditValue & "' and EleCfP = 1 and EleCfAnno =" & ANNO & " order by EleCfAnaDesc,EleCfDataDoc,EleCfNumDoc"
        DsMax = New DataTable
    ...
    End Sub
    Private Sub ButtonP2A_Click(sender As System.Object, e As System.EventArgs) Handles ButtonP2A.Click
        AssociaDaPaginaII()
    End Sub
...
#Region " 3a GRID elenchi"
    Sub IIIPagina()
        StrR = "Select * from VEleda2010 where EleCfTipo = '" & RadioGroup1.EditValue & "' and EleCfP > 1  AND EleCfAnno = " & ANNO & " order by EleCfAnaDesc,EleCfUnion,EleCfDataDoc,EleCfNumDoc"
        DsEle = New DataTable
    ...
    End Sub
    Private Sub ButtonP3I_Click(sender As System.Object, e As System.EventArgs) Handles ButtonP3I.Click
        DissociaDaPaginaIII()
    End Sub
...
#Region " 4a GRID Dati Integrativi Esteri"
    ...
    Sub AggiornaDatiEsteri()
        ...
        PAGINVIO = False
    End Sub
    Private Sub AdvBandedGridView1_ShownEditor(sender As Object, e As System.EventArgs) Handles AdvBandedGridView1.ShownEditor
...
#Region " 5a GRID note variazione"
    ...
    Sub AggiornaVariazioni()
        ...
        PAGVAR = False
    End Sub
    Private Sub AdvBandedGridView2_ShownEditor(sender As Object, e As System.EventArgs) Handles AdvBandedGridView2.ShownEditor
...
#Region " 6a CREAZIONE FILE INVIO"
    ...
    Private Sub NomeFiles()
        ...
        End If
        FileEle = PathEle & TextEdit2.EditValue & "_SPES01.txt"
...
#Region "CHIUDO ed Esco"
    Private Sub DxElenIva_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        RegistraIndici()
        If PAGINVIO = True Then AggiornaDatiEsteri()
        If PAGVAR = True Then AggiornaVariazioni()
    End Sub
...
#Region "UNISCI o DISSOCIA FATTURE"
    Private Sub ButtonUN_Click(sender As System.Object, e As System.EventArgs) Handles ButtonUN.Click
        UnionFatture()
    End Sub
    Sub UnionFatture()
        OpzControl = GridView52.GetSelectedRows
...
#Region "AGGIORNA VARIAZIONE e MODALITA' PAGAMENTO"
    Private Sub GridView52_RowUpdated(sender As Object, e As DevExpress.XtraGrid.Views.Base.RowObjectEventArgs) Handles GridView52.RowUpdated
...
#Region "CREAZIONE FILE ELENCHI"
    Private Sub ButtonF11_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonF11.Click
        If ANNO = 2010 And ControlloLimite() = False Then Exit Sub
    ...
    Private Sub ButtonF8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonF8.Click
        ...
        DXANTEPRIMA(GridControl3, True, Printing.PaperKind.A4, "STAMPA di CONTROLLO FILE " & FileEle, , , , , GridControl1)

    End Sub
    Function ControlloLimite() As Boolean
        ControlloLimite = True
        Dim Cmd As New SqlCommand("Select count(*) from XVERIFICASPE2010 where ERRORE > ''", cnCo)
        Dim Errori As Integer = Cmd.ExecuteScalar
        If Errori > 0 Then
            Messaggio(1, "** ATTENZIONE ERRORE BLOCCANTE PER TRASMISSIONE ** - FATTURE IN ELENCO CON IMPORTO INFERIORE A € 25.000 E PAGAMENTO NON FRAZIONATO!!!")
