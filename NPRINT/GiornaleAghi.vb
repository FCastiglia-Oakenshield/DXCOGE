...
Public Module GiornaleAghi
    Dim PathPrg, PathFil, Orig, Dest, FtFm, Ftmp, Concat, Stampa, QualeLp, QualeReg, NomeFile, DataAl, Priga, QualeTipo As String
    Dim PathSto, FtSt, Tdoc, Causale(72), IT(6), DalAl As String
    ...
    Dim Bollo, Comprimi, Intesta As Boolean
    Dim TotaleGenerale As Decimal = 0
    Dim DsGio As DataSet
    Dim DaGio As SqlDataAdapter
    Dim RwGio As DataRow

    Public Function PrintGiornale(ByVal QSTAMPANTE As String, ByVal INBOLLO As Boolean, ByVal COMPRESSA As Boolean, ByVal LPTIPO As String, ByVal LPRESET As String, ByVal UART As Int32, _
     ByVal RIPO As Decimal, ByVal ANNOG As Int16, ByVal PP As Int32, ByVal LIBRO As String, ByVal AZI As String, ByVal Periodo As String) As Boolean
        ...
        MaxCorp = 47 '( + 5 ) 4 sopra 1 riporto sotto
        'Else
        '    MaxCorp = 88
        'End If
        settaggi(0)
    ...
    Private Function SezChiude() As Boolean
        ...
        PrintLine(1, PRTRIP) ''' RIGA A RIPORTO
...
RITORNO:
    ...
    Private Function SezTestata() As Boolean
        ...
        Pagine = Pagine + 1
        If Pagine > 1 Then
            PrintLine(1, PRT(4)) ''' RIGA A RIPORTO
            PrintLine(1, Chr(12))
            '''' eventuali multipi di stampa per evitare tempi attesa troppo lunghi
            If (Pagine / BlobPagine) - Int(Pagine / BlobPagine) = 0 And QualeTipo <> "F" Then
                FileClose(1)
                settaggi(1)
                settaggi(0)
        ...
        If Pagine = 1 Then      ' Open file for output.
            FileOpen(1, NomeFile, OpenMode.Append)
            RigheVuote(1)
        End If
        ...
        PrintLine(1, PRT(1))
        PrintLine(1, PRT(2))
        PrintLine(1, PRT(3)) ''' RIGA RIPORTO
    End Function
