...
Public Class StE14
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MESE() As CrystalDecisions.[Shared].IParameterField
        Get
