...
Public Module IvaPeriodoPdf
    Dim Orig, Stampa, QualeLp, QualeReg, NomeFile, IntestaT, Datadel As String
    ...
    REM VENTILAZIONE
    Dim LORDOC, TM(72), TY(72), PS(72), AA(72), WSMERANN(72), WSPSM(72), CIIPERC(72), TP, TPP, TPOR, TTPOR, MERCE, INE, NNET, TX, TCN, IVAPUBB As Decimal
    ...
    ByRef OKCHIUDO As Boolean, ByVal PB As Int16, ByRef PP As Int32, ByVal AZI As String, ByVal DESCREG As String, ByVal SIMULATA As Boolean, ByRef NOMESTAMPA As String, ByRef INTERESSI As Decimal) As Boolean
        ...
        MaxVerEu = LIMITE
        Trimestrale = TRIM
        NomeFile = PathTmp & "IVP" & TDESC & ".Pdf"
        NOMESTAMPA = NomeFile
        VerifyDir()
        'MaxCorp = 58
        MaxCorp = 52
        ...
        End If
        '''AND IvaPMese not between " & RMIN & " And " & RMAX & " group by IvaPCodIva"
        DsMer = New DataSet
...
SVENTILA:
        ...
        PRT(0) = "".PadLeft(8, " ") & " VENTILAZIONE CORRISPETTIVI " & Format(LORDOC, "###,###,##0.00")

        PRT(1) = "".PadLeft(8, " ") & "".PadRight(92, "-")
        PRT(2) = "".PadLeft(8, " ") & "|" & "Aliq. " & "|" & "Acq. Lordi  " & "|" & " % Composizione" & "|" & " Corr.Lordi  " & "|" & "Aliq. " & "|" & "Corrispett.Netti" & "|" & "Iva Corrispett. " & "|"
        PRT(3) = "".PadLeft(8, " ") & "".PadRight(92, "=")
        ...
        End If
        Linea = Linea + 3
        myPhrase = New Phrase(PRT(0) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
...
WVENTILA:
        For i As Int16 = 1 To 72
            ...
            myPhrase.Add(New Phrase(LpVe(11) & Microsoft.VisualBasic.Chr(10) & ""))
...
ZVENTILA:
        ...
        myPhrase.Add(New Phrase(LpVe(11) & Microsoft.VisualBasic.Chr(10) & ""))
        myPhrase.Add(New Phrase(PRT(3) & Microsoft.VisualBasic.Chr(10) & ""))
        myPhrase.Add(New Phrase("" & Microsoft.VisualBasic.Chr(10) & ""))
        doc.Add(myPhrase)
        DsIve.AcceptChanges()
    End Function
    Private Sub LpVch(ByVal Lpve() As String)
        Lpve(11) = Lpve(11).PadLeft(8, " ") & "|"
    ...
    Private Function SezChiude() As Boolean
        ...
        Str = "".PadLeft(66, " ")
        PRT(0) = Str.PadRight(83, "-")
        Str = "".PadLeft(66, " ")
        PRT(13) = Str.PadRight(83, "=")
...
TLIQUIDA:
        ...
        End If
        Linea = Linea + 3
        myPhrase = New Phrase(PRT(1) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
        myPhrase.Add(New Phrase(PRT(2).PadRight(68, " ") & Lpdec(1) & Microsoft.VisualBasic.Chr(10) & ""))
        ...
        End If
        Linea = Linea + 3
        myPhrase = New Phrase(PRT(7).PadRight(68, " ") & Lpdec(1) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
        myPhrase.Add(New Phrase(PRT(3) & Microsoft.VisualBasic.Chr(10) & ""))
        myPhrase.Add(New Phrase(PRT(4).PadRight(68, " ") & Lpdec(2) & Microsoft.VisualBasic.Chr(10) & ""))
        doc.Add(myPhrase)
        ...
        If Esente > 0 Then
            ...
            End If
            Linea = Linea + 2
            myPhrase = New Phrase(PRT(6) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
            myPhrase.Add(New Phrase(WT(0) & Lpdec(3) & WT(1) & Lpdec(4) & WT(2) & Lpdec(5) & Microsoft.VisualBasic.Chr(10) & ""))
            doc.Add(myPhrase)
        End If
        ' 1-2 e acconto 
        ...
        Linea = Linea + 3
        myPhrase = New Phrase(PRT(0) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
        myPhrase.Add(New Phrase(PRT(8).PadRight(68, " ") & Lpdec(6) & Microsoft.VisualBasic.Chr(10) & ""))
        myPhrase.Add(New Phrase(PRT(5).PadRight(68, " ") & Lpdec(7) & Microsoft.VisualBasic.Chr(10) & ""))
        doc.Add(myPhrase)

        If Acconto > 0 Then
            Contatore()
            myPhrase = New Phrase(PRT(16).PadRight(68, " ") & Lpdec(11) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
            doc.Add(myPhrase)
        End If
        'credito
        If Credito <> 0 Then
            Contatore()
            myPhrase = New Phrase(PRT(9).PadRight(68, " ") & Lpdec(8) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
            doc.Add(myPhrase)
        End If
        ...
        Linea = Linea + 2
        myPhrase = New Phrase(PRT(0) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
        myPhrase.Add(New Phrase(PRT(10).PadRight(68, " ") & Lpdec(9) & Microsoft.VisualBasic.Chr(10) & ""))
        doc.Add(myPhrase)
        'trimestrale
        If Trimestrale = True And IVALIQ(16) > 0 Then
            Contatore()
            myPhrase = New Phrase(PRT(11).PadRight(68, " ") & Lpdec(10) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
            doc.Add(myPhrase)
        End If
        Linea = Linea + 1
        myPhrase = New Phrase(PRT(0) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
        ...
        If IVALIQ(10) > MaxVerEu Then
            ...
            End If
            Linea = Linea + 2
            myPhrase = New Phrase(PRT(12).PadRight(68, " ") & Lpdec(12) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
            myPhrase.Add(New Phrase(PRT(13) & Microsoft.VisualBasic.Chr(10) & ""))
            doc.Add(myPhrase)
        End If
        ...
        If IVAPUBB > 0 Then
            ...
            End If
            Linea = Linea + 3
            myPhrase = New Phrase(PIPA(0) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
            myPhrase.Add(New Phrase(PIPA(1) & Microsoft.VisualBasic.Chr(10) & ""))
            doc.Add(myPhrase)
        End If
        Linea = Linea + 1
        PRT(15) = " " & PRT(15).PadLeft(130, "*")
        myPhrase = New Phrase(PRT(15) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 6.5))
        doc.Add(myPhrase)
        ...
        If f > 0 Then
            ...
            For z = Linea + 2 To MaxCorp
                PRTRIAS = "".PadLeft(z + 2, " ") & "*"
                If f > 0 Then
                    myPhrase = New Phrase(PRTRIAS & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 6.5))
                    f = 0
                Else
                    myPhrase.Add(New Phrase(PRTRIAS & Microsoft.VisualBasic.Chr(10) & ""))
                End If
            Next
            myPhrase.Add(New Phrase(PRT(15) & Microsoft.VisualBasic.Chr(10) & ""))
            doc.Add(myPhrase)
        End If
ChiudeDefinitivamente:
    ...
    Private Function SezCorpo() As Boolean
        ...
        For x = 0 To 6
            ...
            WT(x) = ""
        Next
        PRT(3) = PRT(3).PadLeft(9, " ") & " N' " & RwRep("IvaPRegIva") & "".PadLeft(15) & QualeReg
        PRT(0) = "".PadLeft(8, " ") & "".PadRight(92, "-")
        PRT(4) = " " & PRT(4).PadLeft(130, "*")
        WT(1) = "".PadLeft(8, " ") & "|" & "Aliquota Iva" & "|" & "  Imponibile o " & "|" & "    I.v.a.    " & "|" & "    I.v.a.    " & "|" _
        & "  Imponibile o " & "|" & "  T O T A L E  " & "|"
        WT(2) = "".PadLeft(8, " ") & "|" & "  Causale   " & "|" & "    Importo    " & "|" & "  Detraibile  " & "|" & " Indetraibile " & "|" _
        & " Importo Merci " & "|" & " F A T T U R E " & "|"

        WT(3) = "".PadLeft(8, " ") & "|" & "Aliquota Iva" & "|" & "    Importo    " & "|" & "    Importo   " & "|" & "    I.v.a.    " & "|" _
            & "               " & "|" & "  T O T A L E  " & "|"
        WT(4) = "".PadLeft(8, " ") & "|" & "  Causale   " & "|" & "    Lordo      " & "|" & "    Netto     " & "|" & "              " & "|" _
        & "               " & "|" & " CORRISPETTIVO " & "|"

        REM pubblica amministrazione
        WT(5) = "".PadLeft(8, " ") & "|" & "Aliquota Iva" & "|" & "  Imponibile o " & "|" & "    I.v.a.    " & "|" & "I.v.a. Indetr." & "|" _
             & "  Imponibile o " & "|" & "  T O T A L E  " & "|"
        WT(6) = "".PadLeft(8, " ") & "|" & "  Causale   " & "|" & "    Importo    " & "|" & "  Detraibile  " & "|" & " o Pubb.Ammin." & "|" _
        & " Importo Merci " & "|" & " F A T T U R E " & "|"
        ...
        myPhrase = New Phrase(PRT(3) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
        myPhrase.Add(New Phrase(PRT(0) & Microsoft.VisualBasic.Chr(10) & ""))
        myPhrase.Add(New Phrase(PRT(1) & Microsoft.VisualBasic.Chr(10) & ""))
        myPhrase.Add(New Phrase(PRT(2) & Microsoft.VisualBasic.Chr(10) & ""))
        myPhrase.Add(New Phrase(PRT(0) & Microsoft.VisualBasic.Chr(10) & ""))
        ...
        For k = 0 To DsIvp.Tables(0).Rows.Count - 1
            ...
            Next
            myPhrase = New Phrase(Lpdec(11) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
            doc.Add(myPhrase)
        Next
        Contatore()
        myPhrase = New Phrase(PRT(0) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
    ...
    Private Function SezTestata() As Boolean
        ...
        For x = 0 To 4
            IRT(x) = ""
        Next
        PRT = "".PadLeft(15, " ") & "LIQUIDAZIONE I.V.A. DEL " & Datadel & " RELATIVA " & IntestaT
        Pagine = Pagine + 1
        If Pagine > 1 Then
            doc.NewPage()
        End If
        ...
        Else
            ...
            myPhrase = New Phrase(IRT(0) & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 6.5))
            myPhrase.Add(New Phrase(IRT(1) & Microsoft.VisualBasic.Chr(10) & ""))
            myPhrase.Add(New Phrase(IRT(2) & Microsoft.VisualBasic.Chr(10) & ""))
            myPhrase.Add(New Phrase(IRT(3) & Microsoft.VisualBasic.Chr(10) & ""))
            myPhrase.Add(New Phrase(IRT(4) & Microsoft.VisualBasic.Chr(10) & ""))
            myPhrase.Add(New Phrase(IRT(0) & Microsoft.VisualBasic.Chr(10) & ""))
            doc.Add(myPhrase)
        End If
        '' INTESTAZIONE Chiusura '''
        myPhrase = New Phrase(PRT & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
        myPhrase.Add(New Phrase(" " & Microsoft.VisualBasic.Chr(10) & ""))
        doc.Add(myPhrase)
        Linea = 2
    End Function
    ...
    Private Function RigheVuote(ByVal n) As Boolean
        Dim x As Int16
        For x = 1 To n
            myPhrase = New Phrase("" & Microsoft.VisualBasic.Chr(10) & "", New Font(Font.COURIER, 8.0))
            doc.Add(myPhrase)
        Next
    End Function
