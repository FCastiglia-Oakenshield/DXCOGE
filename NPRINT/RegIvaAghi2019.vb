...
Public Module RegIvaAghi2019
    Dim PathPrg, PathFil, Orig, Dest, FtFm, Ftmp, FtSt, Concat, Stampa, QualeLp, QualeReg, NomeFile, DataAl, Priga, PSerie As String
    ...
    ByVal LPTIPO As String, ByVal LPRESET As String, ByRef FILEST As String, ByRef PP As Int32, ByVal AZI As String, ByVal DESCREG As String, ByVal SERIEL As String) As Boolean
        ...
        MaxCorp = 52
        Linea = 0
        Tdoc = "RI" & NRREG '' tipo documento registri iva + NR REGISTRO
        Rif = BLOCK
        FtSt = PathSto & Tdoc
        FILEST = FtSt & BLOCK
        settaggi(0)
        ...
        For k = 0 To TesTest
            ...
            If s = 0 Then
                ...
                If Vendite = True Then
                    If RwRep("PRegNumDoc").ToString.Contains("/") Then LpDec(3) = RwRep("PRegNumDoc") Else LpDec(3) = RwRep("PRegNumProt") & PSerie
                Else
...
Ritorno:
    ...
    Private Sub LpLp(ByVal Lpdec() As String)
        ...
        Lpdec(2) = "" '' Lpdec(2).PadLeft(7, " ")
        Lpdec(3) = Lpdec(3).PadLeft(20, " ") & "|"
...
fine:
        ...
        If Pagine > 0 Then
            ...
            System.IO.File.Copy(FtFm, FtSt, True)
        End If
    End Function
